...
public class RestAssuredSimpleTest {
    ...
    public void simple_get_test() {
        given().
                ...
                get(Configuration.ROOT_URI + "/schedules").then().assertThat().body("size()", greaterThanOrEqualTo(0));
    }
    ...
    public void connectionSucceded() {
        given().
                auth().
                oauth2(Configuration.accessToken).
                get(Configuration.ROOT_URI + "/schedules").then().assertThat().statusCode(200);
    }
}
